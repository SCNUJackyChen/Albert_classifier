...
class BertProcessor(object):
    ...
    def get_labels(self):
        ...
        return ['科学计数法', '图形的初步认识', '等差数列', '代数意义', '绝对值', '找规律', '其他', '反比例函数', '勾股定理', '非负性', '分类讨论', '数轴', '一元二次方程', '一元一次方程', '不等式与不等式组', '三角形', '混合运算', '几何', '锐角三角函数', '图表题', '最值问题', '数形结合', '函数', '相似', '面积问题', '求值问题', '二次函数', '参数问题', '实数', '多项式', '整式', '代入求值', '一次函数', '有理数', '方程与方程组', '倒数', '整式的加减', '动点问题', '四边形', '平面直角坐标系', '分式', '整式的乘除与分解因式', '相交线与平行线', '等比数列', '投影与视图', '幂的计算', '添括号去括号', '全等三角形', '证明题', '轴对称', '平方根', '立方根', '二次方程', '二次根式', '旋转', '二元一次方程组', '单项式', '恒等变换', '数列', '圆', '合并同类项', '相反数']
